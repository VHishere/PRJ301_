...
<section class="jumbotron text-center">
    <div class="container">
        <h1 class="jumbotron-heading">Shop mua bán giày số 1 Việt Nam</h1>
        <p class="lead text-muted mb-0">Chúng tôi đã có hơn 10 năm cung cấp các sản phầm giày nhập khẩu từ nhiều nơi trên thế giới.</p>
    </div>
</section>
